...
function loadSettings() {
  chrome.storage.local.get(['voskUrl', 'sourceLang', 'targetLang', 'apiKey', 'apiBaseUrl', 'apiModel', 'aiCorrection', 'webAppUrl', 'extApiKey', 'extUserId'], (res) => {
    ...
    if (res.extUserId) inputExtUserId.value = res.extUserId;
  });
}
